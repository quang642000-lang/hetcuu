...
public class GioHangRepoImpl implements IGioHangRepository {
    ...
    public List<ChiTietGioHang> getChiTietGioHang(int maGh) {
        ...
        // JOIN SAN_PHAM to retrieve mother product flags cho_phep_doi_da & cho_phep_doi_duong
        ...
        try (Connection conn = DBConnect.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    // Map joined columns into an Associated SanPham object for ultimate clean architecture
