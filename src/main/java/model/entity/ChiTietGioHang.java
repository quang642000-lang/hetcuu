...
public class ChiTietGioHang {
    ...
    private String tenSize; // THÊM ĐỂ ĐỒNG BỘ ĐỘNG TÊN SIZE XL/GIANT CHUẨN ĐẸP
    ...
    public boolean getChonMua() { return isChonMua; } // Ánh xạ chuẩn cho EL ${item.chonMua}
    public boolean getIsChonMua() { return isChonMua; } // Ánh xạ dự phòng cho EL ${item.isChonMua}
