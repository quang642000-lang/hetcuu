...
public class SanPham {
    ...
    public boolean isChoPhepDoiDa() {
        return choPhepDoiDa;
    }

    public void setChoPhepDoiDa(boolean choPhepDoiDa) {
        this.choPhepDoiDa = choPhepDoiDa;
    }

    public boolean isChoPhepDoiDuong() {
        return choPhepDoiDuong;
    }

    public void setChoPhepDoiDuong(boolean choPhepDoiDuong) {
        this.choPhepDoiDuong = choPhepDoiDuong;
    }
