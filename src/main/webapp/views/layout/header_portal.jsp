...
<head>
    ...
    <!-- Nhúng CSS & Javascript nền móng Design System -->
...
<!-- CHƯƠNG TRÌNH KHUYẾN MÃI BANNER CHẠY CHỮ TRÊN CÙNG (MARQUEE) -->
<div class="bg-success text-white text-center py-2 fs-6 fw-semibold" style="background-color: var(--primary-color) !important; font-size: 13px !important; letter-spacing: 0.5px;">
    🎉 THƯỞNG 1 ĐIỂM CRM CHO MỖI 10.000 VNĐ CHI TIÊU - TỰ ĐỘNG THĂNG HẠNG VÀ NHẬN VÍ VOUCHER VIP! [10]
</div>

<!-- NỘI DUNG THANH HEADER CHÍNH -->
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top py-3 shadow-sm">
    <div class="container">
        ...
        <!-- Nút Menu thu gọn trên màn hình thiết bị di động -->
        ...
        <div class="collapse navbar-collapse" id="portalNavbarCollapse">
            ...
            <!-- Phân hệ giỏ hàng và tương tác tài khoản -->
            <div class="d-flex align-items-center gap-3">
                <!-- Nút Giỏ hàng trực tuyến có kèm Badge động -->
                ...
                <!-- Đối soát phiên làm việc của Khách hàng thành viên CRM -->
                <c:choose>
                    <c:when test="${not empty sessionScope.customer}">
                        <!-- Dropdown khi khách hàng đã đăng nhập thành công -->
                        <div class="dropdown">
                            <a class="d-flex align-items-center text-decoration-none dropdown-toggle text-dark" href="#" id="customerProfileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="${not empty sessionScope.customer.hinhAnhUrl ? sessionScope.customer.hinhAnhUrl : 'https://cdn-icons-png.flaticon.com/512/3177/3177440.png'}"
                                     alt="Avatar" class="rounded-circle border border-2 border-success me-2" style="width: 38px; height: 38px; object-fit: cover;">
                    ...
                    <c:otherwise>
                        <!-- Nút Đăng nhập cho khách vãng lai hoặc chưa có phiên Session -->
