        ...
        <div class="row w-100 align-items-center">
            <div class="col-12 col-md-7">
                ...
                <a href="${pageContext.request.contextPath}/products" class="btn btn-light text-success fw-bold px-4 py-2.5 shadow-sm">
                    <i class="bi bi-cup-hot-fill me-1"></i> Đặt món ngay bây giờ
                </a>
            </div>
            <div class="col-5 d-none d-md-block text-center">
                <img src="https://static.vecteezy.com/system/resources/previews/034/770/583/non_2x/bubble-tea-ai-generative-free-png.png" class="img-fluid floating-animation" style="max-height: 280px;" alt="Banner Tea">
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card product-card h-100 border-0 shadow-sm bg-white p-3">
                    <div class="position-relative mb-3">
                        <span class="position-absolute top-0 start-0 badge bg-danger text-white fw-bold m-2 px-2.5 py-1.5" style="border-radius: 8px;">🔥 HOT</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-auto">
                        ...
                        <a href="${pageContext.request.contextPath}/product/detail?id=${sp.maSp}" class="btn btn-success btn-sm px-3 fw-bold rounded-pill">
                            Đặt ngay
                        </a>
                    </div>
                </div>
