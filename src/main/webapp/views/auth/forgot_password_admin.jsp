...
<head>
    ...
    <style>
        ...
        .forgot-card { width: 100%; max-width: 460px; background-color: #ffffff; border-radius: 16px; box-shadow: 0 8px 30px rgba(15, 23, 42, 0.15); overflow: hidden; border: 1px solid var(--border-color); }
        .card-header-teapos { background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); color: white; text-align: center; padding: 30px 25px; }
    </style>
</head>
<body>
    ...
    <div class="p-4 text-start">
        ...
        <form action="${pageContext.request.contextPath}/forgot-password" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" class="form-control form-control-teapos py-2.5" name="email" value="<c:out value='${email}'/>" placeholder="Ví dụ: nhanvien@teapos.vn..." required>
            </div>
            <button type="submit" class="btn btn-dark w-100 py-3 fw-bold text-uppercase" style="background-color: #0f172a; border-color: #0f172a;"><i class="bi bi-send-fill me-1"></i> Nhận mã OTP xác thực</button>
