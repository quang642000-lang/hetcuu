                    ...
                    <div class="card card-teapos p-4 bg-white shadow-sm" style="border-radius: 12px;">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/settings" method="POST" id="formPassword">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" id="oldPassword" name="oldPassword" class="form-control form-control-teapos" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-4">
                                <label for="confirmPassword" class="form-label text-muted small fw-semibold">Xác nhận mật khẩu</label>
                                <input type="password" id="confirmPassword" name="confirmPassword" class="form-control form-control-teapos" required>
                            </div>
                            <button type="submit" class="btn btn-primary-teapos w-100 fw-bold">
                                <i class="bi bi-key-fill me-1"></i> Ghi nhận đổi mật khẩu
                            </button>
                        </form>
                    </div>
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("formPassword").addEventListener("submit", function(e) {
            ...
            if (newPass.length < 8) {
                e.preventDefault();
                Swal.fire({ icon: 'warning', title: 'Mật khẩu yếu', text: 'Mật khẩu phải từ 8 ký tự trở lên!', confirmButtonColor: '#2e7d32' });
                return;
            }
            if (newPass !== confirm) {
                e.preventDefault();
                Swal.fire({ icon: 'warning', title: 'Không trùng khớp', text: 'Xác nhận mật khẩu mới không đúng!', confirmButtonColor: '#2e7d32' });
            }
        });
    });
</script>
