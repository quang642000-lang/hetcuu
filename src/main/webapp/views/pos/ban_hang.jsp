...
<div class="pos-wrapper">
    <!-- TOP BAR -->
    <nav class="navbar navbar-dark bg-dark px-2 px-sm-3" style="height: 60px; flex-shrink: 0; z-index: 1040;">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center gap-1 gap-sm-3">
                ...
                <div class="d-flex align-items-center gap-1 gap-sm-2 border-start ps-1.5 ps-sm-3 border-secondary" style="height: 30px;">
                    <a href="${pageContext.request.contextPath}/pos" class="btn btn-sm btn-success fw-bold px-2 px-sm-3 d-flex align-items-center gap-1" style="font-size: 11px; font-size: 12px;">
                        <i class="bi bi-cart-fill text-warning"></i>
                        <span class="d-none d-sm-inline">TẠI QUẦY</span>
                    </a>
                    <a href="${pageContext.request.contextPath}/pos/nhandon" class="btn btn-sm btn-outline-light fw-bold px-2 px-sm-3 d-flex align-items-center gap-1" style="font-size: 11px; font-size: 12px;">
            ...
            <div class="d-flex align-items-center gap-1.5 gap-sm-3 text-white ms-auto">
                ...
                <span class="small border-end pe-1.5 pe-sm-3 border-secondary font-monospace d-none d-lg-inline">
        ...
        <div class="pos-checkout-sidebar">
            <div class="pos-checkout-header">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <!-- Close button visible ONLY on mobile/tablet viewports -->
                    <button type="button" class="btn-close d-lg-none" aria-label="Close" onclick="toggleMobileCart()"></button>
                </div>
            </div>
            ...
            <div class="pos-summary-panel">
                ...
                <!-- CASH SUGGESTIONS AND REFUND ESTIMATOR -->
                ...
                <button type="button" class="btn btn-primary-teapos w-100 py-3 fs-5 fw-bold shadow-sm" onclick="submitPOSOrderTransaction()">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (msg === 'createsuccess' && orderId) {
            ...
            // NATIVELY CLEAR URL PARAMS TO PREVENT DUPLICATE POPUP ON F5 REFRESH!
            const url = new URL(window.location.href);
            url.searchParams.delete('msg');
            url.searchParams.delete('orderId');
            url.searchParams.delete('maPt');
            url.searchParams.delete('payable');
